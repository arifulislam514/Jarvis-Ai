...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when", "why", "which", "whose", "whom", "can you" "could you", "would you", "is", "are", "do", "does", "did", "will", "shall", "may", "might"]
...
#Function to translate text into English useing the mtranslate library.
